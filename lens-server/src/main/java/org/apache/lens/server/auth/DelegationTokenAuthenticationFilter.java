...
public class DelegationTokenAuthenticationFilter implements ContainerRequestFilter {
  private static final String DELEGATION_TKN_HEADER = "X-Hadoop-Delegation-Token";
  private static final String AUTH_SCHEME = "Digest-MD5";
  private static final Path PATH_TO_CHECK = new Path("/tmp");
  ...
  public void filter(ContainerRequestContext requestContext) throws IOException {
    ...
    String delegationToken = requestContext.getHeaderString(DELEGATION_TKN_HEADER);
